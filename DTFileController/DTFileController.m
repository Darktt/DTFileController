...
- (NSString *)convertFileSizeWithSize:(NSNumber *)fileSize
{
    ...
    NSString *fileSizeString = [NSString stringWithFormat:@"%.1f B", _fileSize];
    
    if (_fileSize > 1024.0f) {
        _fileSize /= 1024.0f;
        
        fileSizeString = [NSString stringWithFormat:@"%.1f KB", _fileSize];
    }
    
    if (_fileSize > 1024.0f) {
        _fileSize /= 1024.0f;
        
        fileSizeString = [NSString stringWithFormat:@"%.1f MB", _fileSize];
    }
    
    if (_fileSize > 1024.0f) {
        _fileSize /= 1024.0f;
        
        fileSizeString = [NSString stringWithFormat:@"%.1f GB", _fileSize];
    }
